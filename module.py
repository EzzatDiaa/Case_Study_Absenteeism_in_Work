...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            diseases = reason_columns.loc[:,1:14].max(axis=1)
            pregnancy = reason_columns.loc[:,15:17].max(axis=1)
            poisoning = reason_columns.loc[:,18:21].max(axis=1)
            light_reasons = reason_columns.loc[:,22:].max(axis=1)
            ...
            column_names = ['Date', 'Transportation Expense', 'Distance to Work', 'Age',
                           ...
                           'Pets', 'Absenteeism Time in Hours', 'diseases', 'pregnancy', 'poisoning', 'light_reasons']
            df.columns = column_names

            # re-order the columns in df
            column_names_reordered = ['diseases', 'pregnancy', 'poisoning', 'light_reasons', 'Date', 'Transportation Expense', 
            ...
            # re-order the columns in df
            column_names_upd = ['diseases', 'pregnancy', 'poisoning', 'light_reasons', 'Months_values', 'Day_of_week',
